...
namespace SFramework.Threading.Tasks.Internal
{
    internal static class DiagnosticsExtensions
    {
        ...
        private static string BeautifyType(Type t, bool shortName)
        {
            ...
            if (!t.IsGenericType) return shortName ? t.Name : t.FullName.Replace("SFramework.Threading.Tasks.Triggers.", "").Replace("SFramework.Threading.Tasks.Internal.", "").Replace("SFramework.Threading.Tasks.", "") ?? t.Name;
            ...
            return typeBeautifyRegex.Replace(genericType, "").Replace("SFramework.Threading.Tasks.Triggers.", "").Replace("SFramework.Threading.Tasks.Internal.", "").Replace("SFramework.Threading.Tasks.", "") + "<" + innerFormat + ">";
        }
        ...
        private static bool IgnoreLine(MethodBase methodInfo)
        {
            ...
            else if (declareType.StartsWith("SFramework.Threading.Tasks.CompilerServices"))
            {
                return true;
            }
            ...
            else if (declareType.StartsWith("SFramework.Threading.Tasks.AwaiterActions"))
            {
                return true;
            }
